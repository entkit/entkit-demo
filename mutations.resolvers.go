...
func (r *mutationResolver) CreateVendor(ctx context.Context, input ent.CreateVendorInput) (*ent.Vendor, error) {
	err := ent.DemoEnforceWebsiteCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Vendor.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateVendor(ctx context.Context, id uuid.UUID, input ent.UpdateVendorInput) (*ent.Vendor, error) {
	err := ent.DemoEnforceWebsiteUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Vendor.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteVendors(ctx context.Context, where ent.VendorWhereInput) (int, error) {
	err := ent.DemoEnforceWebsiteDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Vendor.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateWarehouse(ctx context.Context, input ent.CreateWarehouseInput) (*ent.Warehouse, error) {
	err := ent.DemoEnforceWarehouseCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Warehouse.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateWarehouse(ctx context.Context, id uuid.UUID, input ent.UpdateWarehouseInput) (*ent.Warehouse, error) {
	err := ent.DemoEnforceWarehouseUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Warehouse.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteWarehouses(ctx context.Context, where ent.WarehouseWhereInput) (int, error) {
	err := ent.DemoEnforceWarehouseDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
...
func (r *mutationResolver) UpdateProduct(ctx context.Context, id uuid.UUID, input ent.UpdateProductInput) (*ent.Product, error) {
	err := ent.DemoEnforceProductUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Product.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteProducts(ctx context.Context, where ent.ProductWhereInput) (int, error) {
	err := ent.DemoEnforceProductDelete(ctx)
	if err != nil {
		return 1, err
	}
	p, err := where.P()
...
func (r *mutationResolver) UpdateCompany(ctx context.Context, id uuid.UUID, input ent.UpdateCompanyInput) (*ent.Company, error) {
	err := ent.DemoEnforceCompanyUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Company.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteCompanies(ctx context.Context, where ent.CompanyWhereInput) (int, error) {
	err := ent.DemoEnforceCompanyDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Company.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateCountry(ctx context.Context, input ent.CreateCountryInput) (*ent.Country, error) {
	err := ent.DemoEnforceCountryCreate(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) UpdateCountry(ctx context.Context, id uuid.UUID, input ent.UpdateCountryInput) (*ent.Country, error) {
	err := ent.DemoEnforceCountryUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Country.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteCountries(ctx context.Context, where ent.CountryWhereInput) (int, error) {
	err := ent.DemoEnforceCountryDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Country.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreatePhone(ctx context.Context, input ent.CreatePhoneInput) (*ent.Phone, error) {
	err := ent.DemoEnforcePhoneCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Phone.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdatePhone(ctx context.Context, id uuid.UUID, input ent.UpdatePhoneInput) (*ent.Phone, error) {
	err := ent.DemoEnforcePhoneUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Phone.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeletePhones(ctx context.Context, where ent.PhoneWhereInput) (int, error) {
	err := ent.DemoEnforcePhoneDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Phone.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateLocation(ctx context.Context, input ent.CreateLocationInput) (*ent.Location, error) {
	err := ent.DemoEnforceLocationCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Location.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateLocation(ctx context.Context, id uuid.UUID, input ent.UpdateLocationInput) (*ent.Location, error) {
	err := ent.DemoEnforceLocationUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Location.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteLocations(ctx context.Context, where ent.LocationWhereInput) (int, error) {
	err := ent.DemoEnforceLocationDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Location.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateWebsite(ctx context.Context, input ent.CreateWebsiteInput) (*ent.Website, error) {
	...
	return ent.FromContext(ctx).Website.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateWebsite(ctx context.Context, id uuid.UUID, input ent.UpdateWebsiteInput) (*ent.Website, error) {
	...
	return ent.FromContext(ctx).Website.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteWebsites(ctx context.Context, where ent.WebsiteWhereInput) (int, error) {
	...
	return ent.FromContext(ctx).Website.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateEmail(ctx context.Context, input ent.CreateEmailInput) (*ent.Email, error) {
	err := ent.DemoEnforceEmailCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Email.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateEmail(ctx context.Context, id uuid.UUID, input ent.UpdateEmailInput) (*ent.Email, error) {
	err := ent.DemoEnforceEmailUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Email.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteEmails(ctx context.Context, where ent.EmailWhereInput) (int, error) {
	err := ent.DemoEnforceEmailDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Email.Delete().Where(p).Exec(ctx)
}
...
func (r *mutationResolver) CreateImage(ctx context.Context, input ent.CreateImageInput) (*ent.Image, error) {
	err := ent.DemoEnforceImageCreate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Image.Create().SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) UpdateImage(ctx context.Context, id uuid.UUID, input ent.UpdateImageInput) (*ent.Image, error) {
	err := ent.DemoEnforceImageUpdate(ctx)
	if err != nil {
		return nil, err
	}
	return ent.FromContext(ctx).Image.UpdateOneID(id).SetInput(input).Save(ctx)
}
...
func (r *mutationResolver) DeleteImages(ctx context.Context, where ent.ImageWhereInput) (int, error) {
	err := ent.DemoEnforceImageDelete(ctx)
	if err != nil {
		return 0, err
	}
	p, err := where.P()
	...
	return ent.FromContext(ctx).Image.Delete().Where(p).Exec(ctx)
}
