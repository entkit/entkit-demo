...
export const CompanyCreateAction: React.FC<CompanyCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/com/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
...
export const CountryCreateAction: React.FC<CountryCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/country/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const EmailCreateAction: React.FC<EmailCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/email/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const ImageCreateAction: React.FC<ImageCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/image/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const LocationCreateAction: React.FC<LocationCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/location/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const PhoneCreateAction: React.FC<PhoneCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/phone/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const ProductCreateAction: React.FC<ProductCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/product/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const VendorCreateAction: React.FC<VendorCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/vendor/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const WarehouseCreateAction: React.FC<WarehouseCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/warehouse/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
...
export const WebsiteCreateAction: React.FC<WebsiteCreateActionProps> = ({
    ...
    return can ? (
        <Link to={"/website/create".replace(":id", String(recordItemIDs[0]))}>
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
                {...additionalProps}
                {...props}
