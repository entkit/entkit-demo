    ...
    return can ? (
        <Link
            to={
                ...
                "com/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
...
export const CompanyCreateAction: React.FC<CompanyCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "com/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
...
export const CompanyEditAction: React.FC<CompanyEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "com/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
...
export const CountryShowAction: React.FC<CountryShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "country/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const CountryCreateAction: React.FC<CountryCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "country/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const CountryEditAction: React.FC<CountryEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "country/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const EmailShowAction: React.FC<EmailShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "email/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const EmailCreateAction: React.FC<EmailCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "email/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const EmailEditAction: React.FC<EmailEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "email/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const ImageShowAction: React.FC<ImageShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "image/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const ImageCreateAction: React.FC<ImageCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "image/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const ImageEditAction: React.FC<ImageEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "image/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const LocationShowAction: React.FC<LocationShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "location/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const LocationCreateAction: React.FC<LocationCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "location/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const LocationEditAction: React.FC<LocationEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "location/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const PhoneShowAction: React.FC<PhoneShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "phone/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const PhoneCreateAction: React.FC<PhoneCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "phone/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const PhoneEditAction: React.FC<PhoneEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "phone/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const ProductShowAction: React.FC<ProductShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "product/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const ProductCreateAction: React.FC<ProductCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "product/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const ProductEditAction: React.FC<ProductEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "product/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const VendorShowAction: React.FC<VendorShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "vendor/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const VendorCreateAction: React.FC<VendorCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "vendor/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const VendorEditAction: React.FC<VendorEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "vendor/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const WarehouseShowAction: React.FC<WarehouseShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "warehouse/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const WarehouseCreateAction: React.FC<WarehouseCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "warehouse/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const WarehouseEditAction: React.FC<WarehouseEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "warehouse/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
...
export const WebsiteShowAction: React.FC<WebsiteShowActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "website/show/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EyeOutlined />}
...
export const WebsiteCreateAction: React.FC<WebsiteCreateActionProps> = ({
    recordItemIDs,
    hideText,
    onSuccess,
    ...props
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "website/create".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.PlusCircleOutlined />}
...
export const WebsiteEditAction: React.FC<WebsiteEditActionProps> = ({
    ...
    return can ? (
        <Link
            to={
                window.environment.appPath +
                "website/edit/:id".replace(":id", String(recordItemIDs[0]))
            }
        >
            <Antd.Button
                icon={<AntdIcons.EditOutlined />}
