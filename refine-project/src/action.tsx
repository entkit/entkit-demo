...
export const CompanyShowAction: React.FC<CompanyShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "com/show/:id".replace(":id", String(recordItemIDs[0])) }>
...
export const CompanyListAction: React.FC<CompanyListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "com".replace(":id", String(recordItemIDs[0])) }>
...
export const CompanyCreateAction: React.FC<CompanyCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "com/create".replace(":id", String(recordItemIDs[0])) }>
...
export const CompanyEditAction: React.FC<CompanyEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "com/edit/:id".replace(":id", String(recordItemIDs[0])) }>
...
export const CountryShowAction: React.FC<CountryShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "country/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const CountryListAction: React.FC<CountryListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "country".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const CountryCreateAction: React.FC<CountryCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "country/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const CountryEditAction: React.FC<CountryEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "country/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const EmailShowAction: React.FC<EmailShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "email/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const EmailListAction: React.FC<EmailListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "email".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const EmailCreateAction: React.FC<EmailCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "email/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const EmailEditAction: React.FC<EmailEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "email/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const ImageShowAction: React.FC<ImageShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "image/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const ImageListAction: React.FC<ImageListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "image".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const ImageCreateAction: React.FC<ImageCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "image/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const ImageEditAction: React.FC<ImageEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "image/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const LocationShowAction: React.FC<LocationShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "location/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const LocationListAction: React.FC<LocationListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "location".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const LocationCreateAction: React.FC<LocationCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "location/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const LocationEditAction: React.FC<LocationEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "location/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const PhoneShowAction: React.FC<PhoneShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "phone/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const PhoneListAction: React.FC<PhoneListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "phone".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const PhoneCreateAction: React.FC<PhoneCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "phone/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const PhoneEditAction: React.FC<PhoneEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "phone/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const ProductShowAction: React.FC<ProductShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "product/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const ProductListAction: React.FC<ProductListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "product".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const ProductCreateAction: React.FC<ProductCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "product/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const ProductEditAction: React.FC<ProductEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "product/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const VendorShowAction: React.FC<VendorShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "vendor/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const VendorListAction: React.FC<VendorListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "vendor".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const VendorCreateAction: React.FC<VendorCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "vendor/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const VendorEditAction: React.FC<VendorEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "vendor/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const WarehouseShowAction: React.FC<WarehouseShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "warehouse/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const WarehouseListAction: React.FC<WarehouseListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "warehouse".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const WarehouseCreateAction: React.FC<WarehouseCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "warehouse/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const WarehouseEditAction: React.FC<WarehouseEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "warehouse/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
...
export const WebsiteShowAction: React.FC<WebsiteShowActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "website/show/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EyeOutlined/> } {...additionalProps} {...props} >
            {hideText || "Show"}
        </Antd.Button>
    </Link> : null
...
export const WebsiteListAction: React.FC<WebsiteListActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "website".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.UnorderedListOutlined/> } {...additionalProps} {...props} >
            {hideText || "List"}
        </Antd.Button>
    </Link> : null
...
export const WebsiteCreateAction: React.FC<WebsiteCreateActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "website/create".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.PlusCircleOutlined/> } {...additionalProps} {...props} >
            {hideText || "Create"}
        </Antd.Button>
    </Link> : null
...
export const WebsiteEditAction: React.FC<WebsiteEditActionProps> = ({recordItemIDs, hideText, onSuccess, ...props}) => {
    ...
    return can ? <Link to={ window.environment.appPath + "website/edit/:id".replace(":id", String(recordItemIDs[0])) }>
        <Antd.Button icon={ <AntdIcons.EditOutlined/> } {...additionalProps} {...props} >
            {hideText || "Edit"}
        </Antd.Button>
    </Link> : null
