...
// region Code
export const DemoCodeViewOnForm: React.FC<TextareaCodeEditorProps> = (props) => {
    return <CodeEditor
        {...props}
        padding={15}
        style={ {
...
export const CompanyBadge: React.FC<Partial<Type.DemoCompanyInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/com/show/:id".replace(":id", String(props.id)) }>
            { props.name }
        </Link>
    </Antd.Popover>
}
...
export const CountryBadge: React.FC<Partial<Type.DemoCountryInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/country/show/:id".replace(":id", String(props.id)) }>
            { props.name }
        </Link>
    </Antd.Popover>
}
...
export const EmailBadge: React.FC<Partial<Type.DemoEmailInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/email/show/:id".replace(":id", String(props.id)) }>
            { props.title }
        </Link>
    </Antd.Popover>
}
...
export const ImageBadge: React.FC<Partial<Type.DemoImageInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/image/show/:id".replace(":id", String(props.id)) }>
...
export const LocationBadge: React.FC<Partial<Type.DemoLocationInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/location/show/:id".replace(":id", String(props.id)) }>
            { props.title }
        </Link>
    </Antd.Popover>
}
...
export const PhoneBadge: React.FC<Partial<Type.DemoPhoneInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/phone/show/:id".replace(":id", String(props.id)) }>
            { props.title }
        </Link>
    </Antd.Popover>
}
...
export const ProductBadge: React.FC<Partial<Type.DemoProductInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/product/show/:id".replace(":id", String(props.id)) }>
...
export const VendorBadge: React.FC<Partial<Type.DemoVendorInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/vendor/show/:id".replace(":id", String(props.id)) }>
            { props.name }
        </Link>
    </Antd.Popover>
}
...
export const WarehouseBadge: React.FC<Partial<Type.DemoWarehouseInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/warehouse/show/:id".replace(":id", String(props.id)) }>
            { props.name }
        </Link>
    </Antd.Popover>
}
...
export const WebsiteBadge: React.FC<Partial<Type.DemoWebsiteInterface>> = (props) => {
    ...
    >
        <Link to={ window.environment.appPath + "/website/show/:id".replace(":id", String(props.id)) }>
            { props.title }
        </Link>
    </Antd.Popover>
}
