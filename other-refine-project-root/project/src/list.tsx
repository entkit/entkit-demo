...
export const CompanyList :React.FC<CompanyListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="company" headerButtons={({ defaultButtons }) => (
        <>
...
export const CountryList :React.FC<CountryListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="country" headerButtons={({ defaultButtons }) => (
        <>
...
export const EmailList :React.FC<EmailListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="email" headerButtons={({ defaultButtons }) => (
        <>
...
export const ImageList :React.FC<ImageListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="image" headerButtons={({ defaultButtons }) => (
        <>
...
export const LocationList :React.FC<LocationListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="location" headerButtons={({ defaultButtons }) => (
        <>
...
export const PhoneList :React.FC<PhoneListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="phone" headerButtons={({ defaultButtons }) => (
        <>
...
export const ProductList :React.FC<ProductListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="product" headerButtons={({ defaultButtons }) => (
        <>
...
export const VendorList :React.FC<VendorListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="vendor" headerButtons={({ defaultButtons }) => (
        <>
...
export const WarehouseList :React.FC<WarehouseListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="warehouse" headerButtons={({ defaultButtons }) => (
        <>
...
export const WebsiteList :React.FC<WebsiteListProps> = ({tableProps, ...props} ) => {
    ...
    return can ? <RA.List {...props} resource="website" headerButtons={({ defaultButtons }) => (
        <>
