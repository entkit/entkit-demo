...
export const CompanyBadge: React.FC<Partial<Type.DemoCompanyInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/com/show/:id".replace(":id", String(props.id))}>
                {props.name}
            </Link>
        </Antd.Popover>
    );
...
export const CountryBadge: React.FC<Partial<Type.DemoCountryInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/country/show/:id".replace(":id", String(props.id))}>
                {props.name}
            </Link>
        </Antd.Popover>
    );
...
export const EmailBadge: React.FC<Partial<Type.DemoEmailInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/email/show/:id".replace(":id", String(props.id))}>
                {props.title}
            </Link>
        </Antd.Popover>
    );
...
export const ImageBadge: React.FC<Partial<Type.DemoImageInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/image/show/:id".replace(":id", String(props.id))}>
                {props.originalURL ? (
                    <Antd.Image
                        width={48}
                        preview={false}
...
export const LocationBadge: React.FC<Partial<Type.DemoLocationInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/location/show/:id".replace(":id", String(props.id))}>
                {props.title}
            </Link>
        </Antd.Popover>
    );
...
export const PhoneBadge: React.FC<Partial<Type.DemoPhoneInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/phone/show/:id".replace(":id", String(props.id))}>
                {props.title}
            </Link>
        </Antd.Popover>
    );
...
export const ProductBadge: React.FC<Partial<Type.DemoProductInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/product/show/:id".replace(":id", String(props.id))}>
                {props.image ? (
...
export const VendorBadge: React.FC<Partial<Type.DemoVendorInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/vendor/show/:id".replace(":id", String(props.id))}>
                {props.name}
            </Link>
        </Antd.Popover>
    );
...
export const WarehouseBadge: React.FC<Partial<Type.DemoWarehouseInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/warehouse/show/:id".replace(":id", String(props.id))}>
                {props.name}
            </Link>
        </Antd.Popover>
    );
...
export const WebsiteBadge: React.FC<Partial<Type.DemoWebsiteInterface>> = (
    ...
    return (
        ...
        >
            <Link to={"/website/show/:id".replace(":id", String(props.id))}>
                {props.title}
            </Link>
        </Antd.Popover>
    );
